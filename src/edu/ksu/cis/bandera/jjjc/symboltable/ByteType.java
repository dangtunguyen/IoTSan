...
public class ByteType extends IntegralType {
	private final static Name name = new Name("byte");
	public final static ByteType TYPE = new ByteType();
/**
 * 
 */
protected ByteType() {
...
public boolean isValidWideningConversion(Type otherType) {
	return (otherType instanceof ShortType) || (otherType instanceof IntType) || (otherType instanceof LongType)
			|| (otherType instanceof FloatType) || (otherType instanceof DoubleType);
}
}
