...
public final class APreDecrementExpStmtExp extends PStmtExp
{
	private PPreDecrementExp _preDecrementExp_;

	public APreDecrementExpStmtExp()
	{
	}
	public APreDecrementExpStmtExp(
	...
	{
		((Analysis) sw).caseAPreDecrementExpStmtExp(this);
	}
	public Object clone()
	{
		return new APreDecrementExpStmtExp(
