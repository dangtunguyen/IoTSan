...
public class LockTest implements Expr, BirConstants {
	 ...
	 */
	public LockTest(Expr lockExpr, int operation,
			 BirThread thread) {
	...
	{
		((ExprSwitch) sw).caseLockTest(this);
	}
	...
	static String operationName(int operation) {
	switch (operation) {
	case LOCK_AVAILABLE: return "lockAvailable";
	case HAS_LOCK: return "hasLock";
	case WAS_NOTIFIED: return "wasNotified";
	default: return "?";
	}
	}
}
