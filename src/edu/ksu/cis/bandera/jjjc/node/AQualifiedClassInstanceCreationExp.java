...
public final class AQualifiedClassInstanceCreationExp extends PExp
{
	private PExp _exp_;
	private TDot _dot_;
	private TNew _new_;
	...
	private class ArgumentList_Cast implements Cast
	{
		public Object cast(Object o)
		{
			...
			if((node.parent() != null) &&
				(node.parent() != AQualifiedClassInstanceCreationExp.this))
			{
	...
	public AQualifiedClassInstanceCreationExp()
	{
	}
	public AQualifiedClassInstanceCreationExp(
		PExp _exp_,
	...
	{
		((Analysis) sw).caseAQualifiedClassInstanceCreationExp(this);
	}
	public Object clone()
	{
		return new AQualifiedClassInstanceCreationExp(
