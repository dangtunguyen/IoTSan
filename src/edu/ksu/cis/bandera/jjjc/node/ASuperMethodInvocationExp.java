...
public final class ASuperMethodInvocationExp extends PExp
{
	...
	private class ArgumentList_Cast implements Cast
	{
		public Object cast(Object o)
		{
			...
			if((node.parent() != null) &&
				(node.parent() != ASuperMethodInvocationExp.this))
			{
	...
	public ASuperMethodInvocationExp()
	{
	}
	public ASuperMethodInvocationExp(
		TSuper _super_,
	...
	{
		((Analysis) sw).caseASuperMethodInvocationExp(this);
	}
	public Object clone()
	{
		return new ASuperMethodInvocationExp(
