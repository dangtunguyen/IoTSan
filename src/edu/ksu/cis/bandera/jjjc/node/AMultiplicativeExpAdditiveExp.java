...
public final class AMultiplicativeExpAdditiveExp extends PAdditiveExp
{
	private PMultiplicativeExp _multiplicativeExp_;

	public AMultiplicativeExpAdditiveExp()
	{
	}
	public AMultiplicativeExpAdditiveExp(
	...
	{
		((Analysis) sw).caseAMultiplicativeExpAdditiveExp(this);
	}
	public Object clone()
	{
		return new AMultiplicativeExpAdditiveExp(
