...
public class DoubleType extends FloatingPointType {
	private final static Name name = new Name("double");
	public final static DoubleType TYPE = new DoubleType();
/**
 * 
 */
...
public boolean isValidNarrowingConversion(Type otherType) {
	return (otherType instanceof ByteType) || (otherType instanceof ShortType) || (otherType instanceof CharType)
			|| (otherType instanceof IntType) || (otherType instanceof LongType) || (otherType instanceof FloatType);
}
/**
 * 
 * @return boolean
