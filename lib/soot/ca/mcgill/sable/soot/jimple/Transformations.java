		...
		// Go through all valueBoxes of this method and perform changes
		{
			...
			while(codeIt.hasNext())
			{
				...
				while(boxIt.hasNext())
				{
					...
					//System.out.println("boxValue: " + box.getValue());
					...
					if(box.getValue() instanceof Local)
					{
						...
						//System.out.println("instance of local: " + l);
						//System.out.println("ToNewLocal: " + (Local) localToNewLocal.get(l));
						//System.out.println("value of box after set to new Local: " + box.getValue());
					}
				}
				/*
				//System.out.println("Test for use boxes: " +s);
