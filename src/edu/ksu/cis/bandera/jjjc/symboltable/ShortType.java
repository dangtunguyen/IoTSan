...
public class ShortType extends IntegralType {
	private final static Name name = new Name("short");
	public final static ShortType TYPE = new ShortType();
/**
 * 
 */
protected ShortType() {
...
public boolean isValidNarrowingConversion(Type otherType) {
	return (otherType instanceof ByteType) || (otherType instanceof CharType);
}
/**
 * 
 * @return boolean
