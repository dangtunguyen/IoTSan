 ...
 *                                                                   *
 ...
 - Added one method setArgCount on 26-Jan-2000 by Hongjun Zheng
   (zheng@cis.ksu.edu). (*)
*/
...
abstract class AbstractInvokeExpr implements InvokeExpr
{
  ...
  public void setArgCount(int newLength)
	{
	  ValueBox newArgs[] = new ValueBox[newLength];

	  for (int i=0; i<newLength; i++)
	newArgs[i]=argBoxes[i];
	  argBoxes=newArgs;
	}
