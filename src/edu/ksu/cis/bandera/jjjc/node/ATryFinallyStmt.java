...
public final class ATryFinallyStmt extends PStmt
{
	private TTry _try_;
	...
	private class CatchClause_Cast implements Cast
	{
		public Object cast(Object o)
		{
			...
			if((node.parent() != null) &&
				(node.parent() != ATryFinallyStmt.this))
			{
	...
	{
		((Analysis) sw).caseATryFinallyStmt(this);
	}
	public Object clone()
	{
		return new ATryFinallyStmt(
