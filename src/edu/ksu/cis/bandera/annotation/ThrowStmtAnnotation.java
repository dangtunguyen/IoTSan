...
import java.util.*;
public class ThrowStmtAnnotation extends SequentialAnnotation {
/**
 * 
 * @param node edu.ksu.cis.bandera.jjjc.node.Node
 */
public ThrowStmtAnnotation(Node node) {
	super(node);
}
/**
 * 
 ...
 */
public Object clone() {
	ThrowStmtAnnotation result = new ThrowStmtAnnotation((Node) node.clone());
	/*
