...
public final class ABinaryExp extends PExp
{
	...
	public ABinaryExp(
		PExp _first_,
		PBinaryOperator _binaryOperator_,
		PExp _second_)
	{
		setFirst(_first_);
	...
	public Object clone()
	{
		return new ABinaryExp(
			...
			(PBinaryOperator) cloneNode(_binaryOperator_),
			(PExp) cloneNode(_second_));
	}
	public PBinaryOperator getBinaryOperator()
	{
		return _binaryOperator_;
	}
	...
	void removeChild(Node child)
	{
		...
		if(_binaryOperator_ == child)
		{
			_binaryOperator_ = null;
			return;
		}
	...
	{
		if(_binaryOperator_ != null)
		{
			_binaryOperator_.parent(null);
		}
