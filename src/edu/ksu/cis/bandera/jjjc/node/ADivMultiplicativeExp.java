...
public final class ADivMultiplicativeExp extends PMultiplicativeExp
{
	private PMultiplicativeExp _multiplicativeExp_;
	private TDiv _div_;
	private PUnaryExp _unaryExp_;

	public ADivMultiplicativeExp()
	{
	}
	public ADivMultiplicativeExp(
	...
	{
		((Analysis) sw).caseADivMultiplicativeExp(this);
	}
	public Object clone()
	{
		return new ADivMultiplicativeExp(
