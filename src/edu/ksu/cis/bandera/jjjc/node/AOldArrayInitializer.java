...
public final class AOldArrayInitializer extends PArrayInitializer
{
	...
	{
		((Analysis) sw).caseAOldArrayInitializer(this);
	}
	public Object clone()
	{
		return new AOldArrayInitializer(
