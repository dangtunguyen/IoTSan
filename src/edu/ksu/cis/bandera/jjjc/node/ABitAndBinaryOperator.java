...
public final class ABitAndBinaryOperator extends PBinaryOperator
{
	private TBitAnd _bitAnd_;

	public ABitAndBinaryOperator()
	{
	}
	public ABitAndBinaryOperator(
		TBitAnd _bitAnd_)
	...
	{
		((Analysis) sw).caseABitAndBinaryOperator(this);
	}
	public Object clone()
	{
		return new ABitAndBinaryOperator(
