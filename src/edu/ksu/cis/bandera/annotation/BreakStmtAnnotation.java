...
public class BreakStmtAnnotation extends SequentialAnnotation {
/**
 * 
 * @param node edu.ksu.cis.bandera.jjjc.node.Node
 */
public BreakStmtAnnotation(Node node) {
	super(node);
}
	public void apply(Switch sw)
	{
		((AnnotationSwitch) sw).caseBreakStmtAnnotation(this);
	}
/**
 * 
 ...
 */
public Object clone() {
	BreakStmtAnnotation result = new BreakStmtAnnotation((Node) node.clone());
	/*
