...
public final class ANamedTypeExp extends PExp
{
	...
	private class Dim_Cast implements Cast
	{
		public Object cast(Object o)
		{
			...
			if((node.parent() != null) &&
				(node.parent() != ANamedTypeExp.this))
			{
	...
	{
		((Analysis) sw).caseANamedTypeExp(this);
	}
	public Object clone()
	{
		return new ANamedTypeExp(
