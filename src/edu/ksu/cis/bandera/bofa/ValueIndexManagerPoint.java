...
/*
 * ValueIndexManagerPoint.java
 * $Id: ValueIndexManagerPoint.java,v 1.2 2002/02/21 07:42:24 rvprasad Exp $
 */
 ...
 */
public class ValueIndexManagerPoint extends ValueIndexManager
{
	/**
	 ...
	 * @param codeIndex the position in the code where the value variant occurs.
	 * @return the index corresponding to the value variant.  */
