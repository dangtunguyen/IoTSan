...
public final class ADecimalIntegerLiteral extends PIntegerLiteral
{
	...
	public ADecimalIntegerLiteral(
		TDecimalIntegerLiteral _decimalIntegerLiteral_)
	{
	...
	public Object clone()
	{
		return new ADecimalIntegerLiteral(
			(TDecimalIntegerLiteral) cloneNode(_decimalIntegerLiteral_));
	}
	public TDecimalIntegerLiteral getDecimalIntegerLiteral()
	{
		return _decimalIntegerLiteral_;
	}
	void removeChild(Node child)
	{
		if(_decimalIntegerLiteral_ == child)
		{
			_decimalIntegerLiteral_ = null;
			return;
		}
	...
	{
		if(_decimalIntegerLiteral_ == oldChild)
		{
	...
	{
		if(_decimalIntegerLiteral_ != null)
		{
			_decimalIntegerLiteral_.parent(null);
		}
		...
		_decimalIntegerLiteral_ = node;
	}
	public String toString()
	{
		return ""
			+ toString(_decimalIntegerLiteral_);
	}
}
