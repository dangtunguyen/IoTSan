...
public final class AInitPrimitiveArrayCreationExp extends PArrayCreationExp
{
	private TNew _new_;
	...
	private class Dim_Cast implements Cast
	{
		public Object cast(Object o)
		{
			...
			if((node.parent() != null) &&
				(node.parent() != AInitPrimitiveArrayCreationExp.this))
			{
	...
	public AInitPrimitiveArrayCreationExp()
	{
	}
	public AInitPrimitiveArrayCreationExp(
		TNew _new_,
	...
	{
		((Analysis) sw).caseAInitPrimitiveArrayCreationExp(this);
	}
	public Object clone()
	{
		return new AInitPrimitiveArrayCreationExp(
