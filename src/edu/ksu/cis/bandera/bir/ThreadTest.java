...
public class ThreadTest implements Expr, BirConstants {
   
  int operation;
  Expr lhs;
  BirThread thread;

  public ThreadTest(Expr lhs,
		    int operation,
		    BirThread thread) {
    this.lhs = lhs;
  ...
  {
    ((ExprSwitch) sw).caseThreadTest(this);
  }
  ...
  public static String operationName(int operation) {
    switch (operation) {
    case THREAD_TERMINATED: return "threadTerminated";
    default: return "?";
    }
  }
}
