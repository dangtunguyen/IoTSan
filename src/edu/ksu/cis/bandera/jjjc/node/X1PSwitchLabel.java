...
public final class X1PSwitchLabel extends XPSwitchLabel
{
	private XPSwitchLabel _xPSwitchLabel_;
	...
	public X1PSwitchLabel(
		XPSwitchLabel _xPSwitchLabel_,
		PSwitchLabel _pSwitchLabel_)
	{
		setXPSwitchLabel(_xPSwitchLabel_);
	...
	{
		return _xPSwitchLabel_;
	}
	void removeChild(Node child)
	{
		if(_xPSwitchLabel_ == child)
		{
			_xPSwitchLabel_ = null;
		}
	...
	{
		if(_xPSwitchLabel_ != null)
		{
			_xPSwitchLabel_.parent(null);
		}
		...
		_xPSwitchLabel_ = node;
	}
	public String toString()
	{
		return "" +
			toString(_xPSwitchLabel_) +
