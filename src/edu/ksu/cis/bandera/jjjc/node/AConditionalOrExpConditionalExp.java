...
public final class AConditionalOrExpConditionalExp extends PConditionalExp
{
	private PConditionalOrExp _conditionalOrExp_;

	public AConditionalOrExpConditionalExp()
	{
	}
	public AConditionalOrExpConditionalExp(
	...
	{
		((Analysis) sw).caseAConditionalOrExpConditionalExp(this);
	}
	public Object clone()
	{
		return new AConditionalOrExpConditionalExp(
