...
public final class AExpressionPropositionDefinition extends PPropositionDefinition
{
	private TExpression _expression_;
	private TId _id_;
	...
	private class Comment_Cast implements Cast
	{
		public Object cast(Object o)
		{
			...
			if((node.parent() != null) &&
				(node.parent() != AExpressionPropositionDefinition.this))
			{
	...
	public AExpressionPropositionDefinition()
	{
	}
	public AExpressionPropositionDefinition(
		TExpression _expression_,
		TId _id_,
		TLParen _lParen_,
		PParams _params_,
		TRParen _rParen_,
	...
	{
		((Analysis) sw).caseAExpressionPropositionDefinition(this);
	}
	public Object clone()
	{
		return new AExpressionPropositionDefinition(
			(TExpression) cloneNode(_expression_),
			(TId) cloneNode(_id_),
	...
	void replaceChild(Node oldChild, Node newChild)
	{
		...
		{
			setExpression((TExpression) newChild);
			return;
		}
	...
	public void setExpression(TExpression node)
	{
