...
public class PreAssertion extends Assertion implements Comparable {
/**
 * PreAssertion constructor comment.
 ...
 */
public PreAssertion(Annotation annotation, edu.ksu.cis.bandera.jjjc.symboltable.Name name, edu.ksu.cis.bandera.jjjc.node.PExp exp, Vector exceptions) throws DuplicateAssertionException {
...
public int compareTo(Object o) {
	if (o instanceof PreAssertion) {
		return name.compareTo(((PreAssertion) o).getName());
	} else {
		return -1;
	}
}
