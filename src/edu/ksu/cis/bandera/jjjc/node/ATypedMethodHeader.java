...
public final class ATypedMethodHeader extends PMethodHeader
{
	...
	private class Modifier_Cast implements Cast
	{
		public Object cast(Object o)
		{
			...
			if((node.parent() != null) &&
				(node.parent() != ATypedMethodHeader.this))
			{
	...
	{
		((Analysis) sw).caseATypedMethodHeader(this);
	}
	public Object clone()
	{
		return new ATypedMethodHeader(
