 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
import java.util.*;
public class ObjectTypeStructure implements TypeStructure {
	protected TypeVariable var;
/**
 * Insert the method's description here.
 * Creation date: (8/21/00 3:35:09 PM)
 * @param tv edu.ksu.cis.bandera.abps.typing.TypeVariable
 */
public ObjectTypeStructure(TypeVariable var) {
	this.var = var;
}
/**
...
public java.util.Set genCoerceConstraints(TypeStructure ats) {
	Set set = new HashSet();
	if (ats instanceof ObjectTypeStructure) {
		// blank
	} else
...
/**
 * Insert the method's description here.
 * Creation date: (8/21/00 3:35:27 PM)
