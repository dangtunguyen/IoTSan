...
public final class APostAssertion extends PAssertion
{
	...
	private class Comment_Cast implements Cast
	{
		public Object cast(Object o)
		{
			...
			if((node.parent() != null) &&
				(node.parent() != APostAssertion.this))
			{
	...
	{
		((Analysis) sw).caseAPostAssertion(this);
	}
	public Object clone()
	{
		return new APostAssertion(
