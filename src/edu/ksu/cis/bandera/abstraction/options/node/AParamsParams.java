...
public final class AParamsParams extends PParams
{
	...
	private class Dim_Cast implements Cast
	{
		public Object cast(Object o)
		{
			...
			if((node.parent() != null) &&
				(node.parent() != AParamsParams.this))
			{
	...
	{
		((Analysis) sw).caseAParamsParams(this);
	}
	public Object clone()
	{
		return new AParamsParams(
