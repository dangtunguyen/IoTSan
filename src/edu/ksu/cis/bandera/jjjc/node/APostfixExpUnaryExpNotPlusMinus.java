...
public final class APostfixExpUnaryExpNotPlusMinus extends PUnaryExpNotPlusMinus
{
	private PPostfixExp _postfixExp_;

	public APostfixExpUnaryExpNotPlusMinus()
	{
	}
	public APostfixExpUnaryExpNotPlusMinus(
	...
	{
		((Analysis) sw).caseAPostfixExpUnaryExpNotPlusMinus(this);
	}
	public Object clone()
	{
		return new APostfixExpUnaryExpNotPlusMinus(
