...
/*
 * FGAction.java
 * $Id: FGAction.java,v 1.2 2002/02/21 07:42:22 rvprasad Exp $
 */

/**
 * The interface to be implemented by actions that need to be performed when new values arrive at a
 * flow graph node.
 *
...
public interface FGAction
{
	 ...
	 *
	 * @param values that triggered the action.
	 */
