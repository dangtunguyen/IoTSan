...
public final class ATryOneTryStmt extends POneTryStmt
{
	private TTry _try_;
	...
	private class CatchClause_Cast implements Cast
	{
		public Object cast(Object o)
		{
			...
			if((node.parent() != null) &&
				(node.parent() != ATryOneTryStmt.this))
			{
	...
	{
		((Analysis) sw).caseATryOneTryStmt(this);
	}
	public Object clone()
	{
		return new ATryOneTryStmt(
