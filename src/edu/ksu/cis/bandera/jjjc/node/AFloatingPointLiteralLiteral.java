...
public final class AFloatingPointLiteralLiteral extends PLiteral
{
	...
	public AFloatingPointLiteralLiteral(
		TFloatingPointLiteral _floatingPointLiteral_)
	{
	...
	public Object clone()
	{
		return new AFloatingPointLiteralLiteral(
			(TFloatingPointLiteral) cloneNode(_floatingPointLiteral_));
	}
	public TFloatingPointLiteral getFloatingPointLiteral()
	{
		return _floatingPointLiteral_;
	}
	void removeChild(Node child)
	{
		if(_floatingPointLiteral_ == child)
		{
			_floatingPointLiteral_ = null;
			return;
		}
	...
	{
		if(_floatingPointLiteral_ == oldChild)
		{
	...
	{
		if(_floatingPointLiteral_ != null)
		{
			_floatingPointLiteral_.parent(null);
		}
		...
		_floatingPointLiteral_ = node;
	}
	public String toString()
	{
		return ""
			+ toString(_floatingPointLiteral_);
	}
}
