...
public final class AInterfaceClassBodyDeclaration extends PClassBodyDeclaration
{
	private PInterfaceDeclaration _interfaceDeclaration_;

	public AInterfaceClassBodyDeclaration()
	{
	}
	public AInterfaceClassBodyDeclaration(
	...
	{
		((Analysis) sw).caseAInterfaceClassBodyDeclaration(this);
	}
	public Object clone()
	{
		return new AInterfaceClassBodyDeclaration(
