...
public final class APrimitiveTypePrimaryExp extends PExp
{
	...
	private class Dim_Cast implements Cast
	{
		public Object cast(Object o)
		{
			...
			if((node.parent() != null) &&
				(node.parent() != APrimitiveTypePrimaryExp.this))
			{
	...
	public APrimitiveTypePrimaryExp()
	{
	}
	public APrimitiveTypePrimaryExp(
	...
	{
		((Analysis) sw).caseAPrimitiveTypePrimaryExp(this);
	}
	public Object clone()
	{
		return new APrimitiveTypePrimaryExp(
