...
public final class APrimitiveTypeArrayCreationExp extends PArrayCreationExp
{
	private TNew _new_;
	...
	private class DimExp_Cast implements Cast
	{
		public Object cast(Object o)
		{
			...
			if((node.parent() != null) &&
				(node.parent() != APrimitiveTypeArrayCreationExp.this))
			{
	...
	public APrimitiveTypeArrayCreationExp()
	{
	}
	public APrimitiveTypeArrayCreationExp(
		TNew _new_,
	...
	{
		((Analysis) sw).caseAPrimitiveTypeArrayCreationExp(this);
	}
	public Object clone()
	{
		return new APrimitiveTypeArrayCreationExp(
