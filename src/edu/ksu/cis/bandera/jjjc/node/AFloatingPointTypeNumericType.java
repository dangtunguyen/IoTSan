...
public final class AFloatingPointTypeNumericType extends PNumericType
{
	...
	public AFloatingPointTypeNumericType(
		PFloatingPointType _floatingPointType_)
	{
	...
	public Object clone()
	{
		return new AFloatingPointTypeNumericType(
			(PFloatingPointType) cloneNode(_floatingPointType_));
	}
