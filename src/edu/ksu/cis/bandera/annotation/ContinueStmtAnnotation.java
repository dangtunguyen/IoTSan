...
public class ContinueStmtAnnotation extends SequentialAnnotation {
/**
 * 
 * @param node edu.ksu.cis.bandera.jjjc.node.Node
 */
public ContinueStmtAnnotation(Node node) {
	super(node);
}
	public void apply(Switch sw)
	{
		((AnnotationSwitch) sw).caseContinueStmtAnnotation(this);
	}
/**
 * 
 ...
 */
public Object clone() {
	ContinueStmtAnnotation result = new ContinueStmtAnnotation((Node) node.clone());
	/*
