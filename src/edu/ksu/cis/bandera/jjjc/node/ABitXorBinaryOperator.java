...
public final class ABitXorBinaryOperator extends PBinaryOperator
{
	private TBitXor _bitXor_;

	public ABitXorBinaryOperator()
	{
	}
	public ABitXorBinaryOperator(
		TBitXor _bitXor_)
	...
	{
		((Analysis) sw).caseABitXorBinaryOperator(this);
	}
	public Object clone()
	{
		return new ABitXorBinaryOperator(
