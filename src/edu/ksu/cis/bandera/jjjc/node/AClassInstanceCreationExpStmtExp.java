...
public final class AClassInstanceCreationExpStmtExp extends PStmtExp
{
	private PClassInstanceCreationExp _classInstanceCreationExp_;

	public AClassInstanceCreationExpStmtExp()
	{
	}
	public AClassInstanceCreationExpStmtExp(
	...
	{
		((Analysis) sw).caseAClassInstanceCreationExpStmtExp(this);
	}
	public Object clone()
	{
		return new AClassInstanceCreationExpStmtExp(
