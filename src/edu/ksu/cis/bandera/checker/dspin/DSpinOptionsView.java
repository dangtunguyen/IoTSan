...
/**
 * The DSpinOptionsView class is a view of the DSpinOptions model that are available
 * which represents the command line options that are available for use
 * with the Spin model checker.
 *
 * @see edu.ksu.cis.bandera.checker.dspin.DSpinOptions
 ...
 */
public class DSpinOptionsView extends JDialog implements edu.ksu.cis.bandera.checker.OptionsView, java.awt.event.ActionListener, java.awt.event.FocusListener {
    ...
    /**
     * dSpinOptions is a model of the command line options that are available
     * for use with the Spin tool through Bandera.
     */
    public static DSpinOptions dSpinOptions;
    /**
     * The log that we will be writing to.
     */
    private static final Category log = Category.getInstance(DSpinOptionsView.class);
...
class IvjEventHandler implements java.awt.event.ActionListener, java.awt.event.FocusListener {
		public void actionPerformed(java.awt.event.ActionEvent e) {
			if (e.getSource() == DSpinOptionsView.this.getNeverClaimCheckBox()) 
				connEtoC1(e);
			if (e.getSource() == DSpinOptionsView.this.getLivenessRadioButton()) 
				connEtoC2(e);
			if (e.getSource() == DSpinOptionsView.this.getSaftyRadioButton()) 
				connEtoC3(e);
			if (e.getSource() == DSpinOptionsView.this.getExhaustiveRadioButton()) 
				connEtoC4(e);
			if (e.getSource() == DSpinOptionsView.this.getSupertraceRadioButton()) 
				connEtoC5(e);
			if (e.getSource() == DSpinOptionsView.this.getHashCompactRadioButton()) 
				connEtoC6(e);
			if (e.getSource() == DSpinOptionsView.this.getOkbutton()) 
				connEtoC7(e);
			if (e.getSource() == DSpinOptionsView.this.getSaveTrailCheckBox()) 
				connEtoC8(e);
			if (e.getSource() == DSpinOptionsView.this.getShortestCheckBox()) 
				connEtoC9(e);
			if (e.getSource() == DSpinOptionsView.this.getPartialOrderCheckBox()) 
				connEtoC10(e);
			if (e.getSource() == DSpinOptionsView.this.getCompressionCheckBox()) 
				connEtoC11(e);
			if (e.getSource() == DSpinOptionsView.this.getAssertionsCheckBox()) 
				connEtoC16();
		};
		public void focusGained(java.awt.event.FocusEvent e) {};
		public void focusLost(java.awt.event.FocusEvent e) {
			if (e.getSource() == DSpinOptionsView.this.getPhysicalTextField()) 
				connEtoC12(e);
			if (e.getSource() == DSpinOptionsView.this.getStateTextField()) 
				connEtoC13(e);
			if (e.getSource() == DSpinOptionsView.this.getDepthTextField()) 
				connEtoC14(e);
			if (e.getSource() == DSpinOptionsView.this.getErrorsTextField()) 
				connEtoC15(e);
			if (e.getSource() == DSpinOptionsView.this.getVectorSizeTextField()) 
				connEtoC18(e);
		};
	};
...
public void actionPerformed(java.awt.event.ActionEvent e) {}
/**
 * When the assertions check box is selected, make sure that the DSpinOptions model
 * is updated to match.  If the check box is selected, assertions should be turned on.
 * Otherwise, turn assertions off in the DSpinOptions.
 */
public void assertionsCheckBox_ActionEvents() {
    dSpinOptions.setAssertions(getAssertionsCheckBox().isSelected());
}
 /**
...
public void compressionCheckBox_ActionPerformed(java.awt.event.ActionEvent actionEvent) {
	dSpinOptions.setCompression(getCompressionCheckBox().isSelected());
	//return;
}
/**
...
/**
 * connEtoC18:  (VectorSizeTextField.focus.focusLost(java.awt.event.FocusEvent) --> DSpinOptionsView.vectorSizeTextField_FocusLost()V)
 * @param arg1 java.awt.event.FocusEvent
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
...
public void depthTextField_FocusLost(java.awt.event.FocusEvent focusEvent) {
	try {
		dSpinOptions.setSearchDepth(Integer.parseInt(getDepthTextField().getText()));
	} catch (Exception e) {
		JOptionPane.showMessageDialog(null, e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
		getDepthTextField().setText("" + dSpinOptions.getSearchDepth());
	}
	//return;
}
/**
...
public void errorsTextField_FocusLost(java.awt.event.FocusEvent focusEvent) {
	try {
		dSpinOptions.setStopAtError(Integer.parseInt(getErrorsTextField().getText()));
	} catch (Exception e) {
		JOptionPane.showMessageDialog(null, e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
		getErrorsTextField().setText("" + dSpinOptions.getStopAtError());
	}
	//return;
}
/**
...
public void exhaustiveRadioButton_ActionPerformed(java.awt.event.ActionEvent actionEvent) {
	dSpinOptions.setSearchMode(DSpinOptions.EXHAUSTIVE_SEARCH_MODE);
	//return;
}
/**
...
public void hashCompactRadioButton_ActionPerformed(java.awt.event.ActionEvent actionEvent) {
	dSpinOptions.setSearchMode(DSpinOptions.HASH_COMPACT_SEARCH_MODE);
	//return;
}
 /**
...
public void init(edu.ksu.cis.bandera.checker.Options options) {
	...
	if((options != null) && (options instanceof DSpinOptions)) {
		dSpinOptions = (DSpinOptions)options;

		// now get the values and init the GUI view
		getShortestCheckBox().setSelected(dSpinOptions.getFindShortestTrail());
		getSaveTrailCheckBox().setSelected(dSpinOptions.getSaveAllTrails());
		getAssertionsCheckBox().setSelected(dSpinOptions.getAssertions());
		getLivenessRadioButton().setSelected(dSpinOptions.getAcceptanceCycles()); // opposite of safety
		getSaftyRadioButton().setSelected(dSpinOptions.getSafety()); // opposite of liveness/acceptance cycles
		getPartialOrderCheckBox().setSelected(dSpinOptions.getPartialOrderReduction());
		getCompressionCheckBox().setSelected(dSpinOptions.getCompression());
		getSaveTrailCheckBox().setSelected(dSpinOptions.getSaveAllTrails());
		// memory count
		// vector size
		getDepthTextField().setText(String.valueOf(dSpinOptions.getSearchDepth()));
		getPhysicalTextField().setText(String.valueOf(dSpinOptions.getMemoryLimit()));
		getErrorsTextField().setText(String.valueOf(dSpinOptions.getStopAtError()));
		getStateTextField().setText(String.valueOf(dSpinOptions.getSpaceEstimate()));
		
		switch(dSpinOptions.getSearchMode()) {
			case DSpinOptions.EXHAUSTIVE_SEARCH_MODE:
				getExhaustiveRadioButton().setSelected(true);
				break;
			case DSpinOptions.SUPER_TRACE_SEARCH_MODE:
				getSupertraceRadioButton().setSelected(true);
				break;
			case DSpinOptions.HASH_COMPACT_SEARCH_MODE:
...
public void livenessRadioButton_ActionPerformed(java.awt.event.ActionEvent actionEvent) {
	dSpinOptions.setAcceptanceCycles(true);
	//dSpinOptions.setAssertions(false);
	dSpinOptions.setSafety(false);
	//return;
}
/**
...
public static void main(java.lang.String[] args) {
	try {
		DSpinOptionsView aDSpinOptionsView;
		aDSpinOptionsView = new DSpinOptionsView();
		DSpinOptions dSpinOptions = new DSpinOptions();
		aDSpinOptionsView.init(dSpinOptions);
		CompletionListener cl = new CompletionListener() {
			public void complete(Object o) {
				
				if((o != null) && (o instanceof DSpinOptionsView)) {
					DSpinOptionsView dSpinOptionsView = (DSpinOptionsView)o;
					dSpinOptionsView.setVisible(false);
					try {
						DSpinOptions dSpinOptions = (DSpinOptions)dSpinOptionsView.getOptions();
						System.out.println("dspinOptions = " + dSpinOptions.getCommandLineOptions());
						System.out.println("dspin compiler options = " + dSpinOptions.getCompilerCommandLineOptions());
						System.out.println("dspin pan options = " + dSpinOptions.getPanCommandLineOptions());
					}
					catch(Exception e) {
					}
				}
		...
		aDSpinOptionsView.registerCompletionListener(cl);
		aDSpinOptionsView.setModal(true);
		aDSpinOptionsView.addWindowListener(new java.awt.event.WindowAdapter() {
			public void windowClosing(java.awt.event.WindowEvent e) {
				System.exit(0);
			};
		});
		aDSpinOptionsView.setVisible(true);
...
public void neverClaimCheckBox_ActionPerformed(java.awt.event.ActionEvent actionEvent) {
		dSpinOptions.setApplyNeverClaim(getNeverClaimCheckBox().isSelected());
	//return;
}
/**
...
public void okbutton_ActionPerformed(java.awt.event.ActionEvent actionEvent) {
     ...
     * @pre dSpinOptions != null
     */
    public void parseCompileOptions(String compileOptions) {
	
	if(dSpinOptions == null) {
	    log.error("dSpinOptions is null.  Cannot parse compile options without a valid dSpinOptions.");
	    return;
	}

	dSpinOptions.parseCompilerCommandLineOptions(compileOptions);
	...
	default:
	    log.debug("A new search mode must have been added with a value of " +
			       dSpinOptions.getSearchMode());
	}
	
	getPhysicalTextField().setText(Integer.toString(dSpinOptions.getMemoryLimit()));
	getSaftyRadioButton().setSelected(dSpinOptions.getSafety());
	getCompressionCheckBox().setSelected(dSpinOptions.getCompression());
	...
	if(dSpinOptions == null) {
	    log.error("dSpinOptions is null.  Cannot parse pan options without a valid dSpinOptions.");
	    return;
	}

	dSpinOptions.parsePanCommandLineOptions(panOptions);
	
	getDepthTextField().setText(Integer.toString(dSpinOptions.getSearchDepth()));
	getLivenessRadioButton().setSelected(dSpinOptions.getAcceptanceCycles());
	getAssertionsCheckBox().setSelected(dSpinOptions.getAssertions());
	getErrorsTextField().setText(Integer.toString(dSpinOptions.getStopAtError()));
	getSaveTrailCheckBox().setSelected(dSpinOptions.getSaveAllTrails());
	getShortestCheckBox().setSelected(dSpinOptions.getFindShortestTrail());
...
public void partialOrderCheckBox_ActionPerformed(java.awt.event.ActionEvent actionEvent) {
	dSpinOptions.setPartialOrderReduction(getPartialOrderCheckBox().isSelected());
	//return;
}
/**
 * Comment
...
public void physicalFieldMemory_FocusLost(java.awt.event.FocusEvent focusEvent) {
	try {
		dSpinOptions.setMemoryLimit(Integer.parseInt(getPhysicalTextField().getText()));
	} catch (Exception e) {
		JOptionPane.showMessageDialog(null, e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
		getPhysicalTextField().setText("" + dSpinOptions.getMemoryLimit());
	}
	//return;
}
/**
...
public void saftyRadioButton_ActionPerformed(java.awt.event.ActionEvent actionEvent) {
	dSpinOptions.setAcceptanceCycles(false);
	//dSpinOptions.setAssertions(getAssertionsCheckBox().isSelected());
	dSpinOptions.setSafety(true);
	//return;
}
/**
 * Comment
...
public void saverailCheckBox_ActionPerformed(java.awt.event.ActionEvent actionEvent) {
		dSpinOptions.setSaveAllTrails(getSaveTrailCheckBox().isSelected());
	//return;
}
...
public void shortestCheckBox_ActionPerformed(java.awt.event.ActionEvent actionEvent) {
	dSpinOptions.setFindShortestTrail(getShortestCheckBox().isSelected());
	//return;
}
/**
 * Comment
...
public void stateTextField_FocusLost(java.awt.event.FocusEvent focusEvent) {
	try {
		dSpinOptions.setSpaceEstimate(Integer.parseInt(getStateTextField().getText()));
	} catch (Exception e) {
		JOptionPane.showMessageDialog(null, e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
		getStateTextField().setText("" + dSpinOptions.getSpaceEstimate());
	}
	//return;
}
/**
...
public void supertraceRadioButton_ActionPerformed(java.awt.event.ActionEvent actionEvent) {
	dSpinOptions.setSearchMode(DSpinOptions.SUPER_TRACE_SEARCH_MODE);
	//return;
}
/**
...
public void vectorSizeTextField_FocusLost() {
	try {
		...
		dSpinOptions.setVectorSize(vectorSize);
	}
	catch(Exception e) {
