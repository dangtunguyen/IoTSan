...
import java.util.*;
public class ExpStmtAnnotation extends SequentialAnnotation {
/**
 * 
 * @param node edu.ksu.cis.bandera.jjjc.node.Node
 */
public ExpStmtAnnotation(Node node) {
	super(node);
}
	public void apply(Switch sw)
	{
		((AnnotationSwitch) sw).caseExpStmtAnnotation(this);
	}
/**
 * 
 ...
 */
public Object clone() {
	ExpStmtAnnotation result = new ExpStmtAnnotation((Node) node.clone());
	/*
