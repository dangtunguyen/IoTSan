...
public final class AExclusiveOrExpInclusiveOrExp extends PInclusiveOrExp
{
	private PExclusiveOrExp _exclusiveOrExp_;

	public AExclusiveOrExpInclusiveOrExp()
	{
	}
	public AExclusiveOrExpInclusiveOrExp(
	...
	{
		((Analysis) sw).caseAExclusiveOrExpInclusiveOrExp(this);
	}
	public Object clone()
	{
		return new AExclusiveOrExpInclusiveOrExp(
