...
/*
 * WorkList.java
 * $Id: WorkList.java,v 1.2 2002/02/21 07:42:25 rvprasad Exp $
 */
...
public class WorkList
{
	 ...
	 *
	 * @param work the new work to be added to the list.
	 */
	public void insert(FGWork work)
    {
		list.addLast(work);
    }
	 ...
	 *
	 * @return the current work in the list.
	 */
	public FGWork remove()
    {
		return (FGWork) list.removeFirst();
    }
