...
/**
 * InstanceOf check (see if referent of reference contained in type)
 */
...
public class InstanceOfExpr implements Expr {
  ...
  public InstanceOfExpr(Expr refExpr,  Type aggType) {
  ...
  public boolean equals(Object o) {
    ...
    return this.refExpr.equals(other.refExpr) 
      && this.aggType.equals(other.aggType);
  }

  public Expr getRefExpr() { return refExpr; }
  public Type getArgType() { return aggType; }
