...
public final class AConstantDeclarationInterfaceMemberDeclaration extends PInterfaceMemberDeclaration
{
	...
	{
		((Analysis) sw).caseAConstantDeclarationInterfaceMemberDeclaration(this);
	}
	public Object clone()
	{
		return new AConstantDeclarationInterfaceMemberDeclaration(
