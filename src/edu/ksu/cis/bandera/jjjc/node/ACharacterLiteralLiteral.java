...
public final class ACharacterLiteralLiteral extends PLiteral
{
	private TCharacterLiteral _characterLiteral_;

	public ACharacterLiteralLiteral()
	{
	}
	public ACharacterLiteralLiteral(
	...
	{
		((Analysis) sw).caseACharacterLiteralLiteral(this);
	}
	public Object clone()
	{
		return new ACharacterLiteralLiteral(
