...
public class LongType extends IntegralType {
	private final static Name name = new Name("long");
	public final static LongType TYPE = new LongType();
/**
 * 
 */
protected LongType() {
...
public boolean isValidNarrowingConversion(Type otherType) {
	return (otherType instanceof ByteType) || (otherType instanceof ShortType) || (otherType instanceof CharType)
			|| (otherType instanceof IntType);
}
/**
 * 
 * @return boolean
...
public boolean isValidWideningConversion(Type otherType) {
	return (otherType instanceof FloatType) || (otherType instanceof DoubleType);
}
}
