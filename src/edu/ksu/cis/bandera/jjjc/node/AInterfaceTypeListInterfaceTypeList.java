...
public final class AInterfaceTypeListInterfaceTypeList extends PInterfaceTypeList
{
	...
	{
		((Analysis) sw).caseAInterfaceTypeListInterfaceTypeList(this);
	}
	public Object clone()
	{
		return new AInterfaceTypeListInterfaceTypeList(
