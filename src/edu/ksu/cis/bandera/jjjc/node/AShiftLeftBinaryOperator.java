...
public final class AShiftLeftBinaryOperator extends PBinaryOperator
{
	private TShiftLeft _shiftLeft_;

	public AShiftLeftBinaryOperator()
	{
	}
	public AShiftLeftBinaryOperator(
	...
	{
		((Analysis) sw).caseAShiftLeftBinaryOperator(this);
	}
	public Object clone()
	{
		return new AShiftLeftBinaryOperator(
