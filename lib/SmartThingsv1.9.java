...
{
	public STState levelState; /* <attribute name>State */
	public int currentLevel; /* current<Uppercase attribute name> */
	...
	public void setLevel(long level, long delay){
		currentLevel = level;
		STCommand_STSwitchLevel_setLevel = true;
	}
	public void setLevel(long level, long rate, long delay){
		currentLevel = level;
		STCommand_STSwitchLevel_setLevel = true;
	}
}
