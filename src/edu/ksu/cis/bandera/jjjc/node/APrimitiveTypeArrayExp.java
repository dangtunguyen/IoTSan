...
public final class APrimitiveTypeArrayExp extends PExp
{
	private TNew _new_;
	...
	private class DimExp_Cast implements Cast
	{
		public Object cast(Object o)
		{
			...
			if((node.parent() != null) &&
				(node.parent() != APrimitiveTypeArrayExp.this))
			{
	...
	{
		((Analysis) sw).caseAPrimitiveTypeArrayExp(this);
	}
	public Object clone()
	{
		return new APrimitiveTypeArrayExp(
