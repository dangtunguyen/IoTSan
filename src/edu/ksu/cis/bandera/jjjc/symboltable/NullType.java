...
public class NullType extends ReferenceType {
	private final static Name name = new Name("null");
	public final static NullType TYPE = new NullType();
/**
 * 
 */
protected NullType() {
...
public boolean isValidWideningConversion(Type otherType) {
	return (otherType instanceof ArrayType) || (otherType instanceof ClassOrInterfaceType);
}
}
