...
public final class ANameArrayType extends PArrayType
{
	...
	private class Dim_Cast implements Cast
	{
		public Object cast(Object o)
		{
			...
			if((node.parent() != null) &&
				(node.parent() != ANameArrayType.this))
			{
	...
	{
		((Analysis) sw).caseANameArrayType(this);
	}
	public Object clone()
	{
		return new ANameArrayType(
