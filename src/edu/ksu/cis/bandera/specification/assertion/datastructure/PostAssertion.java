...
public class PostAssertion extends Assertion implements Comparable {
	private boolean ret;
/**
 * PostAssertion constructor comment.
 ...
 * @param hasRet boolean
 */
public PostAssertion(Annotation annotation, edu.ksu.cis.bandera.jjjc.symboltable.Name name, edu.ksu.cis.bandera.jjjc.node.PExp exp, Vector exceptions, boolean hasRet) throws DuplicateAssertionException {
...
public int compareTo(Object o) {
	if (o instanceof PreAssertion) {
		...
		return 1;
	} else if (o instanceof PostAssertion) {
		return name.compareTo(((PostAssertion) o).getName());
	} else {
		return -1;
	}
}
