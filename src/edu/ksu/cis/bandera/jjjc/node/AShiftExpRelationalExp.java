...
public final class AShiftExpRelationalExp extends PRelationalExp
{
	private PShiftExp _shiftExp_;

	public AShiftExpRelationalExp()
	{
	}
	public AShiftExpRelationalExp(
	...
	{
		((Analysis) sw).caseAShiftExpRelationalExp(this);
	}
	public Object clone()
	{
		return new AShiftExpRelationalExp(
