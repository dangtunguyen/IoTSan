...
public class STCommonAPIs
{
	...
	Date timeTodayAfter(Date startTime, String timeString, TimeZone timeZone){}
	Date timeTodayAfter(Date startTime, Date time, TimeZone timeZone){}
	Date timeTodayAfter(String startTimeString, String timeString){}
	Date timeToday(Date startTime, TimeZone timeZone){}
	Date timeToday(Date startTime){}
	...
	void sendHubCommand(Object command, double delay){}
