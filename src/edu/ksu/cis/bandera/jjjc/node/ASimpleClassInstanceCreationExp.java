...
public final class ASimpleClassInstanceCreationExp extends PExp
{
	private TNew _new_;
	...
	private class ArgumentList_Cast implements Cast
	{
		public Object cast(Object o)
		{
			...
			if((node.parent() != null) &&
				(node.parent() != ASimpleClassInstanceCreationExp.this))
			{
	...
	public ASimpleClassInstanceCreationExp()
	{
	}
	public ASimpleClassInstanceCreationExp(
		TNew _new_,
	...
	{
		((Analysis) sw).caseASimpleClassInstanceCreationExp(this);
	}
	public Object clone()
	{
		return new ASimpleClassInstanceCreationExp(
