...
public final class AStarAssignAssignmentOperator extends PAssignmentOperator
{
	...
	public Object clone()
	{
		return new AStarAssignAssignmentOperator(
			(TStarAssign) cloneNode(_starAssign_));
	}
	...
	{
		if(_starAssign_ != null)
		{
			_starAssign_.parent(null);
		}
