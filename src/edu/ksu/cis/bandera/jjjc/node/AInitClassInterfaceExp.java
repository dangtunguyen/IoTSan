...
public final class AInitClassInterfaceExp extends PExp
{
	private TNew _new_;
	...
	private class Dim_Cast implements Cast
	{
		public Object cast(Object o)
		{
			...
			if((node.parent() != null) &&
				(node.parent() != AInitClassInterfaceExp.this))
			{
	...
	{
		((Analysis) sw).caseAInitClassInterfaceExp(this);
	}
	public Object clone()
	{
		return new AInitClassInterfaceExp(
