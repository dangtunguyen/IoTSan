...
public class EmptyStmtAnnotation extends SequentialAnnotation {
/**
 * EmptyStmtAnnotation constructor comment.
 * @param node edu.ksu.cis.bandera.jjjc.node.Node
 */
public EmptyStmtAnnotation(edu.ksu.cis.bandera.jjjc.node.Node node) {
	super(node);
}
	public void apply(Switch sw)
	{
		((AnnotationSwitch) sw).caseEmptyStmtAnnotation(this);
	}
/**
 * 
 ...
 */
public Object clone() {
	EmptyStmtAnnotation result = new EmptyStmtAnnotation((Node) node.clone());
	return result;
}
/**
 * 
