...
public class FloatType extends FloatingPointType {
	private final static Name name = new Name("float");
	public final static FloatType TYPE = new FloatType();
/**
 * 
 */
protected FloatType() {
...
public boolean isValidNarrowingConversion(Type otherType) {
	return (otherType instanceof ByteType) || (otherType instanceof ShortType) || (otherType instanceof CharType)
			|| (otherType instanceof IntType) || (otherType instanceof LongType);
}
/**
 * 
 * @return boolean
