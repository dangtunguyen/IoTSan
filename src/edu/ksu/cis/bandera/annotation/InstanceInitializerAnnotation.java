...
import java.util.*;
public class InstanceInitializerAnnotation extends BlockStmtAnnotation {
/**
 * InstanceInitializerAnnotation constructor comment.
 * @param node edu.ksu.cis.bandera.jjjc.node.Node
 */
public InstanceInitializerAnnotation(edu.ksu.cis.bandera.jjjc.node.Node node) {
	super(node);
}
/**
 * 
 ...
 */
public Object clone() {
	InstanceInitializerAnnotation result = new InstanceInitializerAnnotation((Node) node.clone());
