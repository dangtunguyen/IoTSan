...
import java.util.*;
public class ReturnStmtAnnotation extends SequentialAnnotation {
/**
 * 
 * @param node edu.ksu.cis.bandera.jjjc.node.Node
 */
public ReturnStmtAnnotation(Node node) {
	super(node);
}
	public void apply(Switch sw)
	{
		((AnnotationSwitch) sw).caseReturnStmtAnnotation(this);
	}
/**
 * 
 ...
 */
public Object clone() {
	ReturnStmtAnnotation result = new ReturnStmtAnnotation((Node) node.clone());
	/*
