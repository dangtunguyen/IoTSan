...
public final class AIncrementUnaryOperator extends PUnaryOperator
{
	private TPlusPlus _plusPlus_;

	public AIncrementUnaryOperator()
	{
	}
	public AIncrementUnaryOperator(
	...
	{
		((Analysis) sw).caseAIncrementUnaryOperator(this);
	}
	public Object clone()
	{
		return new AIncrementUnaryOperator(
