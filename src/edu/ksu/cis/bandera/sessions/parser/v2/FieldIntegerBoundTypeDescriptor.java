 ...
 * Schema.
 * $Id: FieldIntegerBoundTypeDescriptor.java,v 1.1 2003/04/30 19:33:35 tcw Exp $
 */
...
/**
 * Class FieldIntegerBoundTypeDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2003/04/30 19:33:35 $
 */
public class FieldIntegerBoundTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public FieldIntegerBoundTypeDescriptor() {
        super();
        xmlName = "fieldIntegerBoundType";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                FieldIntegerBoundType target = (FieldIntegerBoundType) object;
    ...
    } //-- edu.ksu.cis.bandera.sessions.parser.v2.FieldIntegerBoundTypeDescriptor()
    ...
    {
        return edu.ksu.cis.bandera.sessions.parser.v2.FieldIntegerBoundType.class;
