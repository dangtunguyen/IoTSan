 ...
 * Creation date: (00-11-20 10:01:36)
 * @author: 
 */
public class DroppableLocationsList extends DroppableList {
/**
 * DroppableControlStatementList constructor comment.
 */
public DroppableLocationsList() {
	super();
}
...
public void drop(DropTargetDropEvent dropTargetDropEvent) {
	try {
		...
		if (tr.isDataFlavorSupported(TransferableTreeNode.DEFAULT_MUTABLE_TREENODE_FLAVOR)) {
			...
			SlicePoint sp = criterionViewer.calculateSlicePoint(userObject);
			if (sp != null) {
				boolean isStatementNode = false;
				criterionViewer.addLocationToCriterion(sp, (Annotation) userObject);
			}
