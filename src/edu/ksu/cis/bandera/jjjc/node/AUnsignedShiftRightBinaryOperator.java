...
public final class AUnsignedShiftRightBinaryOperator extends PBinaryOperator
{
	private TUnsignedShiftRight _unsignedShiftRight_;

	public AUnsignedShiftRightBinaryOperator()
	{
	}
	public AUnsignedShiftRightBinaryOperator(
	...
	{
		((Analysis) sw).caseAUnsignedShiftRightBinaryOperator(this);
	}
	public Object clone()
	{
		return new AUnsignedShiftRightBinaryOperator(
