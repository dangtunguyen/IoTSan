...
public class InvokePredicate extends MethodPredicate implements Comparable {
/**
 * 
 ...
 * @param exact boolean
 */
protected InvokePredicate(Name name, ClassOrInterfaceType type, Annotation annotation, edu.ksu.cis.bandera.specification.predicate.node.Node node, Vector exceptions) throws DuplicatePredicateException {
...
public int compareTo(Object o) {
	if (o instanceof InvokePredicate) {
		return name.compareTo(((InvokePredicate) o).getName());
	} else {
		return -1;
	}
}
...
public String toString() {
	Object o = ((edu.ksu.cis.bandera.specification.predicate.node.AInvokePropositionDefinition) node).getParams();
	String s = "INVOKE " + name + "(" + (o != null? o.toString().trim() : "") + ")";
