...
public final class ARelationalExpEqualityExp extends PEqualityExp
{
	private PRelationalExp _relationalExp_;

	public ARelationalExpEqualityExp()
	{
	}
	public ARelationalExpEqualityExp(
	...
	{
		((Analysis) sw).caseARelationalExpEqualityExp(this);
	}
	public Object clone()
	{
		return new ARelationalExpEqualityExp(
