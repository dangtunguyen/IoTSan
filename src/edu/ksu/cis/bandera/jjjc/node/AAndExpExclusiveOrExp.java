...
public final class AAndExpExclusiveOrExp extends PExclusiveOrExp
{
	private PAndExp _andExp_;

	public AAndExpExclusiveOrExp()
	{
	}
	public AAndExpExclusiveOrExp(
		PAndExp _andExp_)
	...
	{
		((Analysis) sw).caseAAndExpExclusiveOrExp(this);
	}
	public Object clone()
	{
		return new AAndExpExclusiveOrExp(
