...
import java.util.*;
public class LogicalOrExpr implements BinopExpr, ToBriefString {
 ...
 */
public LogicalOrExpr(Value v1, Value v2) {
 ...
 */
public LogicalOrExpr(ValueBox valueBox1, ValueBox valueBox2) {
	op1Box = valueBox1;
	op2Box = valueBox2;
}
/**
...
public void apply(Switch sw) {
	((BanderaExprSwitch) sw).caseLogicalOrExpr(this);
}
/**
