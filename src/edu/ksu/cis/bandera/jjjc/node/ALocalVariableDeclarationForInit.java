...
public final class ALocalVariableDeclarationForInit extends PForInit
{
	private PLocalVariableDeclaration _localVariableDeclaration_;

	public ALocalVariableDeclarationForInit()
	{
	}
	public ALocalVariableDeclarationForInit(
	...
	{
		((Analysis) sw).caseALocalVariableDeclarationForInit(this);
	}
	public Object clone()
	{
		return new ALocalVariableDeclarationForInit(
