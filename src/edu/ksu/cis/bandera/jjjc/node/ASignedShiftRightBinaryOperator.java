...
public final class ASignedShiftRightBinaryOperator extends PBinaryOperator
{
	private TSignedShiftRight _signedShiftRight_;

	public ASignedShiftRightBinaryOperator()
	{
	}
	public ASignedShiftRightBinaryOperator(
	...
	{
		((Analysis) sw).caseASignedShiftRightBinaryOperator(this);
	}
	public Object clone()
	{
		return new ASignedShiftRightBinaryOperator(
