 ...
 * Schema.
 * $Id: LockGraphType.java,v 1.1 2003/04/30 19:33:36 tcw Exp $
 */
 ...
 */
public abstract class LockGraphType implements java.io.Serializable {
    ...
    public LockGraphType() {
        super();
        _rootList = new ArrayList();
    } //-- edu.ksu.cis.bandera.sessions.parser.v2.LockGraphType()
