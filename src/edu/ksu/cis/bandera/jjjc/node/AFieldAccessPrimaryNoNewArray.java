...
public final class AFieldAccessPrimaryNoNewArray extends PPrimaryNoNewArray
{
	private PFieldAccess _fieldAccess_;

	public AFieldAccessPrimaryNoNewArray()
	{
	}
	public AFieldAccessPrimaryNoNewArray(
	...
	{
		((Analysis) sw).caseAFieldAccessPrimaryNoNewArray(this);
	}
	public Object clone()
	{
		return new AFieldAccessPrimaryNoNewArray(
