...
public final class APostDecrementExpr extends PPostDecrementExpr
{
	private PPostfixExp _postfixExp_;
	private TMinusMinus _minusMinus_;

	public APostDecrementExpr()
	{
	}
	public APostDecrementExpr(
	...
	{
		((Analysis) sw).caseAPostDecrementExpr(this);
	}
	public Object clone()
	{
		return new APostDecrementExpr(
