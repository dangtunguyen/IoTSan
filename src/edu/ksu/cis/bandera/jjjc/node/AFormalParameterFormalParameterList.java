...
public final class AFormalParameterFormalParameterList extends PFormalParameterList
{
	...
	{
		((Analysis) sw).caseAFormalParameterFormalParameterList(this);
	}
	public Object clone()
	{
		return new AFormalParameterFormalParameterList(
