...
public CustomFileFilter() {
	...
	{
		super();
		setFileList(l); description = desc;
	}
public boolean accept(File file)
{
	...
	for (Enumeration e = RETable.keys(); e.hasMoreElements(); )
	{
		...
		if (isMatched(s,file.getName())) return true;
	}
	return false;
}
...
public static void main(String[] args)
{
	...
	l.addLast("*.gif");
	l.addLast("*.bmp");
	CustomFileFilter ff = new CustomFileFilter(l, "All image formats known to earth");
...
*/		
	...
	System.out.println("Hey ho: "+response);
	//System.exit(-1);
	/*
