...
import java.util.*;
public class StaticInitializerAnnotation extends BlockStmtAnnotation {
/**
 * StaticInitializerAnnotation constructor comment.
 * @param node edu.ksu.cis.bandera.jjjc.node.Node
 */
public StaticInitializerAnnotation(edu.ksu.cis.bandera.jjjc.node.Node node) {
	super(node);
}
/**
 * 
 ...
 */
public Object clone() {
	StaticInitializerAnnotation result = new StaticInitializerAnnotation((Node) node.clone());
