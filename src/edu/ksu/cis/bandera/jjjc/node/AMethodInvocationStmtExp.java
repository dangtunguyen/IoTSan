...
public final class AMethodInvocationStmtExp extends PStmtExp
{
	private PMethodInvocation _methodInvocation_;

	public AMethodInvocationStmtExp()
	{
	}
	public AMethodInvocationStmtExp(
	...
	{
		((Analysis) sw).caseAMethodInvocationStmtExp(this);
	}
	public Object clone()
	{
		return new AMethodInvocationStmtExp(
