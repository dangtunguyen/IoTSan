...
public final class AUnaryExpMultiplicativeExp extends PMultiplicativeExp
{
	private PUnaryExp _unaryExp_;

	public AUnaryExpMultiplicativeExp()
	{
	}
	public AUnaryExpMultiplicativeExp(
	...
	{
		((Analysis) sw).caseAUnaryExpMultiplicativeExp(this);
	}
	public Object clone()
	{
		return new AUnaryExpMultiplicativeExp(
