...
public final class AArrayAccessLeftHandSide extends PLeftHandSide
{
	private PArrayAccess _arrayAccess_;

	public AArrayAccessLeftHandSide()
	{
	}
	public AArrayAccessLeftHandSide(
	...
	{
		((Analysis) sw).caseAArrayAccessLeftHandSide(this);
	}
	public Object clone()
	{
		return new AArrayAccessLeftHandSide(
