...
public final class AFieldAccessLeftHandSide extends PLeftHandSide
{
	private PFieldAccess _fieldAccess_;

	public AFieldAccessLeftHandSide()
	{
	}
	public AFieldAccessLeftHandSide(
	...
	{
		((Analysis) sw).caseAFieldAccessLeftHandSide(this);
	}
	public Object clone()
	{
		return new AFieldAccessLeftHandSide(
